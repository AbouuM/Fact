...
function signup($name, $fname, $alias, $birthday, $email, $pass, $phone)
{
...
function addPost($alias, $title, $content, $userId)
{
...
function updateStatut($commentId, $statut)
{
	$commentManager = new CommentManager();
...
function updateUser($userId, $statut)
{
	$userManager = new UserManager();
...
function adminComment($postId, $author, $comment)
{
	$commentManager = new CommentManager();
...
function receiptMail($name, $email, $subject, $message)
{
